...
function promptPassword(callback) {
    ...
    box.style.cssText = 'background:white;padding:20px;border-radius:8px;text-align:center;font-family:sans-serif;';
    box.innerHTML = `
    ...
    document.getElementById('pwSubmit').onclick = () => {
        const value = document.getElementById('pwInput').value;
        if (value === PASSWORD) {
